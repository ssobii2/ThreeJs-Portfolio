...
const DemoComputer = (props) => {
  ...
  // Use static image texture instead of video texture for performance
  const txt = useMemo(() => {
    if (props.texture && !props.texture.endsWith('.mp4')) {
      const tex = new THREE.TextureLoader().load(props.texture)
      tex.flipY = false
      return tex
    }
    // Fallback - don't load heavy video textures
    return null
  }, [props.texture])
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        >
            {txt ? <meshBasicMaterial map={txt} /> : <meshBasicMaterial color="#1a1a2e" />}
        </mesh>
        <group
          name="RootNode"
          position={[0, 1.093, 0]}
